...
- [swagger-maven-plugin](http://kongchen.github.io/swagger-maven-plugin/) - Support JAX-RS & Spring MVC, a maven build plugin which helps you generate `swagger.json` & static document during build phase.
